...
var AotPlugin = (function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        _c = analyzeAndValidateNgModules(this.symbols, this.ngCompilerHost, compiler._metadataResolver), ngModule = _c.ngModuleByPipeOrDirective, filesToCompile = _c.files, ngModules = _c.ngModules;
                    ...
                    case 1:
                        ...
                        _loop_1 = function (generatedFile) {
                            var genFileUrl, source, srcFileUrl, emitPath, emitFileName, sourceFile, classes, isModule, localDependencies, _i, localDependencies_1, path, dependencies, shouldCompileDependencies, isComponentDependency, hasComponentDependency;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
    ...
    AotPlugin.prototype.getModuleDependencies = function (sourceFile, file) {
        ...
        var loadChildren = getPropertyAssignments(sourceFile)
            ...
            .map(function (_a) {
            var path = _a[0];
            return resolveModuleName(path, file, _this.parsedConfig.options, _this.host);
        })
