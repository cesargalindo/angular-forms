(function (global, factory) {
    ...
    var TransformFile = (function () {
        ...
        TransformFile.prototype.convertLoadChildren = function () {
    ...
    var AotPlugin = (function () {
                    ...
                    return __generator$1(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                if (!(!isCompiling && !isResource && !isNativeModule && !isNodeModule)) return [3 /*break*/, 3];
                                return [4 /*yield*/, this.compilePromise];
                            case 2:
                                _a.sent();
                                _a.label = 3;
        ...
        AotPlugin.prototype.compileFiles = function (files, checkDependencies) {
            ...
            return __awaiter$1(this, void 0, void 0, function () {
                ...
                var compiler, reflector, _i, files_1, file, sourceFiles, _a, sourceFiles_1, sourceFile, symbols, _b, symbols_1, symbol, resolvedSymbol, symbolMetadata, _c, ngModule, filesToCompile, ngModules, cachedItems, _d, filesToCompile_1, analyzedFile, _e, cachedItems_1, item, generatedFiles, _f, filesToCompile_2, file, directives, injectables, ngModules_1, pipes, srcUrl, compiledFile, _loop_1, this_1, _g, generatedFiles_1, generatedFile;
                    ...
                    switch (_h.label) {
                        case 0:
                            ...
                            for (_a = 0, sourceFiles_1 = sourceFiles; _a < sourceFiles_1.length; _a++) {
                                ...
                                for (_b = 0, symbols_1 = symbols; _b < symbols_1.length; _b++) {
                                    symbol = symbols_1[_b];
                            ...
                            _c = _angular_compiler.analyzeAndValidateNgModules(this.symbols, this.ngCompilerHost, compiler._metadataResolver), ngModule = _c.ngModuleByPipeOrDirective, filesToCompile = _c.files, ngModules = _c.ngModules;
                            ...
                            for (_d = 0, filesToCompile_1 = filesToCompile; _d < filesToCompile_1.length; _d++) {
                                analyzedFile = filesToCompile_1[_d];
                                for (_e = 0, cachedItems_1 = cachedItems; _e < cachedItems_1.length; _e++) {
                                    item = cachedItems_1[_e];
                        ...
                        case 1:
                            ...
                            _h.sent();
                            generatedFiles = [];
                            for (_f = 0, filesToCompile_2 = filesToCompile; _f < filesToCompile_2.length; _f++) {
                                file = filesToCompile_2[_f];
                            ...
                            _loop_1 = function (generatedFile) {
                                var genFileUrl, source, srcFileUrl, emitPath, emitFileName, sourceFile, classes, isModule, localDependencies, _i, localDependencies_1, path$$1, dependencies, shouldCompileDependencies, isComponentDependency, hasComponentDependency;
                                return __generator$1(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            if (!shouldCompileDependencies) return [3 /*break*/, 4];
                                            if (!isComponentDependency) return [3 /*break*/, 2];
                                            return [4 /*yield*/, this_1.compileFiles(this_1.componentDependencies.get(emitFileName), false)];
                                        case 1:
                                            _a.sent();
                                            _a.label = 2;
                                        case 2:
                                            if (!hasComponentDependency) return [3 /*break*/, 4];
                            ...
                            this_1 = this;
                            _g = 0, generatedFiles_1 = generatedFiles;
                            _h.label = 2;
                        case 2:
                            if (!(_g < generatedFiles_1.length)) return [3 /*break*/, 5];
                            generatedFile = generatedFiles_1[_g];
        ...
        AotPlugin.prototype.getModuleDependencies = function (sourceFile, file) {
            ...
            var loadChildren = getPropertyAssignments(sourceFile)
                ...
                .map(function (_a) {
                var path$$1 = _a[0];
                return typescript.resolveModuleName(path$$1, file, _this.parsedConfig.options, _this.host);
            })
                .map(function (resolved) { return resolved.resolvedModule.resolvedFileName; });
            for (var _a = 0, loadChildren_1 = loadChildren; _a < loadChildren_1.length; _a++) {
                var child = loadChildren_1[_a];
                var dependencies = this.moduleDependencies.get(file);
